...
const obj_envia_email = document.querySelector('#envia_mail')
...
obj_envia_mail.addEventListener('click', function() {funExibeContato(this.alt) })
...
function funPreencheTabela() {
    if( obj_cpf.value == '' || obj_qtd.value == '' || obj_qtd.value <=0 || obj_qtd.value >20 ) {
